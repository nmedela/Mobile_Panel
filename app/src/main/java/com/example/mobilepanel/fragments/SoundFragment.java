package com.example.mobilepanel.fragments;
...
public class SoundFragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        final LoadingDialogFragment loadingDialogFragment = new LoadingDialogFragment(SoundFragment.this);
        loadingDialogFragment.startLoadingDialog();
